#!/bin/bash
#SBATCH --job-name=lit_esm2
#SBATCH --output=/home/jianpinhe3/virophylo/Phyla/slurm_logs/lit_esm2_%j.out
#SBATCH --error=/home/jianpinhe3/virophylo/Phyla/slurm_logs/lit_esm2_%j.err
...
echo "============================================"
echo " ESM2-650M + NJ on Literature Reference Trees"
...
python evaluate_literature_esm2.py \
